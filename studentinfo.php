            ...
            <?php
             ...
             ?>
                 <tr>
                    ...
                    <th scope="row"><a> Student Name </a></th>
                    <td><?php echo $studentName ?></td>
                </tr>
                    <th scope="row"><a> Student Username </a></th>
                    <td><?php echo $studentUsername ?></td>
                <tr>
                    <th scope="row"><a> Student Email </a></th>
                    <td><?php echo $studentEmail ?></td>
                </tr>
                    <th scope="row"><a> Student Phone number </a></th>
                    <td><?php echo $studentPhoneNo ?></td>
                <tr>
                    <th scope="row"><a> Student Password </a></th>
                    <td><?php echo $studentPass ?></td>
                </tr>
                    <th scope="row"><a> Student Course </a></th>
