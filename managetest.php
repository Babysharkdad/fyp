            ...
            <div class="card-body">
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    <th scope="row">1</th>
                    <td>Depression Anxiety <br> Stress Scales(DASS)</td>
                    <td>
                      <a href="viewrecomend.php" class="btn btn-primary">View</a>
                      <a href="updaterecomend.php" class="btn btn-primary">Update</a>
                      <a href="deleterecomend.php" class="btn btn-primary">Delete</a></td>
                    <td></td>
                  </tr>
                </tbody>
                <a align="right" href="createrecomend.php" class="btn btn-primary">Create Recomendation</a>
              </table>
